...
export const MusicAssistant: React.FC = () => {
  ...
  const handleSend = async (): Promise<void> => {
    ...
    try {
      ...
      const artistContext: string = ARTISTS.map((a: Artist) => `- ${a.name} (${a.category}): ${a.description}. Bio: ${a.bio}`).join('\n');
      ...
      const aiText: string = response.text || "I'm sorry, I couldn't process that. Can you try rephrasing?";
