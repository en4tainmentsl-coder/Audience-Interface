...
const InfoTooltip: React.FC<InfoTooltipProps> = ({ text }) => {
  ...
  return (
    <div className="relative inline-block ml-1 align-middle">
      ...
      {show && (
        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-brand-surface border border-white/10 rounded-lg shadow-2xl text-xs text-gray-300 leading-relaxed animate-fade-in text-left">
          {text}
              ...
              <div>
                ...
                {success ? (
                  ...
                  <form onSubmit={handleSignup} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2 space-y-4 pt-6 border-t border-white/10 text-left">
                      <h3 className="text-lg font-semibold text-brand-purple flex items-center gap-2">
